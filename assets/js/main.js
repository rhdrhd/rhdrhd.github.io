...
(() => {
  ...
  const STRINGS = {
    en: {
      ...
      'now.text': 'AI Research Engineer at Huawei Edinburgh Research Centre. The work focuses on two pillars: making large-scale LLM inference faster and more efficient — especially for agentic AI workloads with multi-agent coordination over complex, multi-step tasks, using runtime scheduling on vLLM-Ascend; and hardware architecture insights — deeply comparing heterogeneous platforms to identify optimal acceleration paths.',
      ...
      'job2.title': 'Technical Insight Specialist',
      ...
      'card4.meta': { light: 'Substack writing', dark: 'scroll · 2025' },
